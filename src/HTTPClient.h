...
public:
  ...
  // Note: setConnectTimeout(int32_t)/setTimeout(uint16_t) above are no-ops too —
  // sim_http_fetch is synchronous; timeouts are firmware-side hints that don't
  // translate to the host curl/WSL stack.
